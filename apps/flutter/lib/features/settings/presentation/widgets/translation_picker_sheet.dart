...
/// Translation-language picker, split out of the main Reader Settings
/// sheet so that sheet stays short. Every control here applies live via
/// Riverpod just like its parent, so there's nothing to Save.
Future<void> showTranslationPickerSheet(BuildContext context) {
  return showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    showDragHandle: false,
    backgroundColor: Colors.transparent,
    builder: (_) => const _TranslationPickerSheet(),
  );
}
          ...
          child: ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(l10n.settingsTranslation, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
                  IconButton(
